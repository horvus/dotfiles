...
void loop()
{
  ...
  // In what mode are we?     // These are the sequences that take place when a

  //correct or incorrect button is pressed
  ...
  case 4:
    newGameSet();
    break; // Case 4 is assigned to a funtion that will reset the game with a new sequence once you have lost
  }
}
